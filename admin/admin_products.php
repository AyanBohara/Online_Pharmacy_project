...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data" onsubmit="return validateForm();">
   ...
   <input type="text" name="p_price" id="p_price" placeholder="enter the product price" class="box" >
   <input type="file" name="p_image" id="p_image" accept="image/png, image/jpg, image/jpeg" class="box">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="admin_products.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="admin_products.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <input type="text" min="0" class="box" required name="update_p_price" id="update_p_price" value="<?php echo $fetch_edit['price']; ?>">
...
function validateForm() {
  ...
  var productImage = document.getElementById("p_image").files[0];
